 ...
 */
class PrayerTimesDarkWidget : AppWidgetProvider() {
    override fun onUpdate(
        ...
        for (appWidgetId in appWidgetIds) {
            updateAppDarkWidget(context, appWidgetManager, appWidgetId)
...
internal fun updateAppDarkWidget(
    context: Context,
    appWidgetManager: AppWidgetManager,
    appWidgetId: Int
) {
    ...
    val views = RemoteViews(context.packageName, R.layout.prayer_times_dark_widget).apply {
